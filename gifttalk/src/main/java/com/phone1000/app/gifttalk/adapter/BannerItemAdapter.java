 ...
 */
public class BannerItemAdapter extends AbsAdapter {

    private List<BannerItemInfo.DataBean.PostsBean> data;
    private LayoutInflater inflater;
    private Context context;
    public BannerItemAdapter(Context context, List<BannerItemInfo.DataBean.PostsBean> data) {
        super(data);
        this.data = data;
